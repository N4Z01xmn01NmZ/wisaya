...
STATIC_ASSERT(sizeof(Wisaya::wsyInt8) == 1, "Expected wsyInt8 to be 1 byte.");
STATIC_ASSERT(sizeof(Wisaya::wsyInt16) == 2, "Expected wsyInt16 to be 2 bytes.");
STATIC_ASSERT(sizeof(Wisaya::wsyInt32) == 4, "Expected wsyInt32 to be 4 bytes.");
STATIC_ASSERT(sizeof(Wisaya::wsyInt64) == 8, "Expected wsyInt64 to be 8 bytes.");

STATIC_ASSERT(sizeof(Wisaya::wsyUInt8) == 1, "Expected wsyUInt8 to be 1 byte.");
STATIC_ASSERT(sizeof(Wisaya::wsyUInt16) == 2, "Expected wsyUInt16 to be 2 bytes.");
STATIC_ASSERT(sizeof(Wisaya::wsyUInt32) == 4, "Expected wsyUInt32 to be 4 bytes.");
STATIC_ASSERT(sizeof(Wisaya::wsyUInt64) == 8, "Expected wsyUInt64 to be 8 bytes.");

STATIC_ASSERT(sizeof(Wisaya::wsyFloat32) == 4, "Expected wsyUInt64 to be 4 bytes.");
STATIC_ASSERT(sizeof(Wisaya::wsyFloat64) == 8, "Expected wsyUInt64 to be 8 bytes.");
